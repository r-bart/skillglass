...
- Use the GitHub README as the product's primary public page and remove the standalone landing until it earns its maintenance cost. (2026-09-06)
...
- Repository visibility, tag and release have not been changed. They require the final publication authorization.
...
- The v1 readiness plan has completed phases 1–5 and local validation. Close protection, root diagnostics, safe Markdown, ES/EN, onboarding, visual polish and release metadata are implemented.
...
- Node 24.19.0 and pnpm 11.5.1: root and E2E typechecks, lint and production dependency audit pass.
...
- The README is now the primary product page, with a branded cover and fixture-backed product screenshot under `docs/assets/`. The standalone Astro landing and its deployment were removed on 2026-09-06.
