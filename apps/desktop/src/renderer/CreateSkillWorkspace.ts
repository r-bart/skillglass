      ...
      createElement(
        ...
        createElement("aside", { className: "create-setup__aside" },
          ...
          createElement("ol", null,
            createElement("li", null, "Skill Forge genera una plantilla editable."),
  ...
  return createElement(
    ...
    createElement("div", { className: "workspace-body" },
      ...
      createElement("aside", { "aria-labelledby": "create-context-title", className: "workspace-context" },
        ...
        createElement("p", { className: "workspace-context__safety" }, "Skill Forge comprobará que el destino sigue libre, publicará la carpeta de forma atómica y conservará una acción de deshacer."))),
