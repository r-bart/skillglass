...
describe("desktop distributable policy", () => {
  ...
  it("keeps the Linux Electron sandbox enabled in native smoke tests", async () => {
    ...
    expect(workflow).toContain("sudo chown root:root apps/desktop/out/Skillglass-linux-*/chrome-sandbox")
    expect(workflow).toContain("sudo chmod 4755 apps/desktop/out/Skillglass-linux-*/chrome-sandbox")
    expect(releaseWorkflow).toContain("sudo chown root:root apps/desktop/out/Skillglass-linux-*/chrome-sandbox")
    expect(releaseWorkflow).toContain("sudo chmod 4755 apps/desktop/out/Skillglass-linux-*/chrome-sandbox")
