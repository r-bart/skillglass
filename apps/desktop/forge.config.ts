...
export const SKILLGLASS_PRODUCT_NAME = "Skillglass"
export const SKILLGLASS_EXECUTABLE_NAME = process.platform === "linux" ? "skillglass" : SKILLGLASS_PRODUCT_NAME
export const SKILLGLASS_ICON_PATH = fileURLToPath(new URL("../../branding/Skillglass.icon", import.meta.url))
export const SKILLGLASS_ICON_ICO_PATH = fileURLToPath(new URL("../../branding/Skillglass.ico", import.meta.url))
export const SKILLGLASS_ICON_PNG_PATH = fileURLToPath(new URL("../../branding/Skillglass.png", import.meta.url))
...
export async function finalizeDarwinAdHocSignature(
  ...
  for (const outputPath of packageResult.outputPaths) {
    await run("/usr/bin/codesign", [
      ...
      "--sign",
      "-",
      path.join(outputPath, `${SKILLGLASS_PRODUCT_NAME}.app`),
    ])
  }
}
...
const config = {
  ...
  makers: [
    new MakerSquirrel({ name: "skillglass", setupIcon: SKILLGLASS_ICON_ICO_PATH }),
    new MakerZIP({}, ["darwin"]),
